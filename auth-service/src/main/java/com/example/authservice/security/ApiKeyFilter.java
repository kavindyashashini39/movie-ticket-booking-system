...
public class ApiKeyFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        // Exempt Swagger & Docs & Actuator & OPTIONS preflight
        ...
        if (apiKeyHeader == null || !apiKeyHeader.equals(expectedApiKey)) {
            ...
            httpResponse.getWriter().write("{\"error\": \"Unauthorized\", \"message\": \"Invalid or missing X-API-KEY header. Direct microservice calls are forbidden.\"}");
            return;
        }
